...
const baseClasses =
  "block w-full px-3 py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-0 sm:text-sm transition-colors duration-200 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white";
