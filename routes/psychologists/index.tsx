...
export const handler: Handlers<PsychologistsPageData, AppState> = {
  async GET(req, ctx) {
    ...
    if (user.role === "psychologist") {
      ...
      const allPsychologists = await userRepository.getUsersByRole(
        "psychologist",
      );
...
export default function PsychologistsPage({
  ...
  const pageDescription = currentUser.role === "psychologist"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {psychologists.map((psychologist) => (
                        ...
                        >
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <Badge
                              variant={psychologist.role === "superadmin"
                                ? "warning"
                                : "default"}
                            >
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                            {new Date(psychologist.createdAt)
                              .toLocaleDateString(
                                "es-ES",
                              )}
                          </td>
